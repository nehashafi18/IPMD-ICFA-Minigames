...
const INSTRUCTIONS: Record<GameType, { title: string; emoji: string; steps: Step[] }> = {
  memory: {
    ...
    emoji: '🔍',
    steps: [
      { icon: '👁️', text: 'An art style appears — look carefully at it' },
      { icon: '🃏', text: 'All cards reveal — spot where your symbol is hiding' },
      { icon: '🌑', text: 'Cards flip face-down — now pick the one you remembered' },
      { icon: '✅', text: 'Correct? Great! Wrong? You\'ll see what it was and move on' },
      { icon: '📈', text: 'Levels get harder: more cards, less time, more rounds' },
    ],
  },
  match3: {
    title: 'Art Match',
